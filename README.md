*最近看到很多项目使用了和这个项目同样的思路，代码结构或者README，但是没有提到这里，总感觉心里凉凉的*  
*其实也不是什么大问题，倒是我是以 AGPL 开源的，也不知道抄思路算不算抄，但我毕竟也没有注册版权，我也不知道我是不是第一个产生这个思路的人*  
*不过心里还是觉得有很多开发者来做这个，完善这个，实现心里的快乐，还是很开心的~*  
